        ...
        <td style="width: 100%; font-size: 9pt; font-color: #404040;">{$before|unescape:'htmlall'}<br /><br />
            ...
            <table style="width: 100%" border="1" cellpadding="5">
                    ...
                    {foreach $products as $product}
                        <tr>
                            ...
                            <td>{$product['name']|escape:'htmlall':'UTF-8'}{if !empty($product['features_name'])}
                                    ({$product['features_name']|escape:'htmlall':'UTF-8'})
                                    {/if}{if !empty($product['combination'])}
                                ({$product['combination']|escape:'htmlall':'UTF-8'}) {/if}</td>
                ...
                <tfoot>
                    ...
                    <tr>
                        <td colspan="2" style="font-weight: bold; background-color: #cccccc;">TOTAL H.T</td>
                        {* <td>{displayPrice price=$cart_info['total_products']}</td> *}
                        <td>{displayPrice price=$cart_info['total_price_without_tax']}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="2" style="font-weight: bold; color: #fff; background-color: #595959;">TOTAL T.T.C
                        </td>
