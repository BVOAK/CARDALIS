...
{block name='page_content'}
    ...
    <div id="action-quotation">
        ...
        <a class="btn cancel-quotation" href="{$link->getModuleLink('pdfquotation', 'accountpdfquotation', ['action' => 'index'])|escape:'html':'UTF-8'}">
            <span>{l s='Cancel' mod='pdfquotation'}</span>
        </a>
        <a class="btn validate-quotation" href="{$link->getModuleLink('pdfquotation', 'accountpdfquotation', ['action' => 'addToExistingCart', 'id_quotation' => $quotationObj->id_quotation])|escape:'html':'UTF-8'}">
