...
<div id="PM_ASCriterionsOutput_{$as_search.id_search|intval}_{$criterions_group.id_criterion_group|intval}" class="PM_ASCriterionsOutput filter-{$criterions_group.name}">
...
{if $as_search.reset_group|intval && isset($as_search.selected_criterion[$criterions_group.id_criterion_group]) && sizeof($as_search.selected_criterion[$criterions_group.id_criterion_group])}
	<a href="#" class="PM_ASResetGroup" rel="{$criterions_group.id_criterion_group|intval}">
		{if $as_search.id_search == '37'}{l s='Tout réinitialiser' mod='pm_advancedsearch4'}{else}{l s='Reset this group' mod='pm_advancedsearch4'}{/if}
	</a>
{/if}
{/if}
