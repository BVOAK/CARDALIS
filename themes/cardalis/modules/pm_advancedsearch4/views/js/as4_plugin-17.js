...
var as4Plugin = {
    ...
    showAsResponse: function (responseText, statusText, xhr, $form) {
        ...
        function activeFiltersAppendTo() {
            if ($(window).innerWidth() >= 768) {
                setTimeout(function () {
                    $("#blockActiveFilters").empty();
    ...
    initSearchEngine: function () {
        ...
        $(document).on('click', '.PM_ASBlockOutput .card-header', function (e) {
            ...
            if ($(window).innerWidth() < 768) {
                ...
                $("#category").addClass("overflowHidden");
                $(".btn_close-filter").show();
                $(".closeFilters").show();
            }
        });

        $(document).on('click', '.btn_close-filter', function (e) {
            $(".PM_ASBlockOutput").removeClass("PM_ASMobileVisible");
            $("#category").removeClass("overflowHidden");  
        });
