...
<div id="add-review-form-review" class="popup-form font-family-custom">
    ...
    <div class="title-rev">
        <div class="title-form-text-left">
            <b class="title-form-custom">{l s='My Review' mod='reviewsadv'}:</b>
    ...
    <div id="body-add-review-form-review" class="text-align-left">
        ...
        {if $reviewsadvdatareview.criterions|@count>0}
                    ...
                    <div class="rat rating-stars-dynamic">
                                                        <span onmouseout="read_rating_review_shop('rat_rel{$criterion.id_reviewsadv_review_criterion|escape:'htmlall':'UTF-8'}');">
                                                            ...
                                                            <img  onmouseover="_rating_efect_rev(1,0,'rat_rel{$criterion.id_reviewsadv_review_criterion|escape:'htmlall':'UTF-8'}')"
                                                                  ...
                                                                  alt="" id="img_rat_rel{$criterion.id_reviewsadv_review_criterion|escape:'htmlall':'UTF-8'}_1" />
                                                            ...
                                                            <img  onmouseover="_rating_efect_rev(2,0,'rat_rel{$criterion.id_reviewsadv_review_criterion|escape:'htmlall':'UTF-8'}')"
                                                                  ...
                                                                  src="{$base_dir_ssl|escape:'htmlall':'UTF-8'}modules/reviewsadv/views/img/{$reviewsadvnoactivestar|escape:'htmlall':'UTF-8'}"
                                                                  alt="" id="img_rat_rel{$criterion.id_reviewsadv_review_criterion|escape:'htmlall':'UTF-8'}_2" />
                                                            ...
                                                            <img  onmouseover="_rating_efect_rev(3,0,'rat_rel{$criterion.id_reviewsadv_review_criterion|escape:'htmlall':'UTF-8'}')"
                                                                  ...
                                                                  src="{$base_dir_ssl|escape:'htmlall':'UTF-8'}modules/reviewsadv/views/img/{$reviewsadvnoactivestar|escape:'htmlall':'UTF-8'}"
                                                                  alt=""  id="img_rat_rel{$criterion.id_reviewsadv_review_criterion|escape:'htmlall':'UTF-8'}_3" />
                                                            <img  onmouseover="_rating_efect_rev(4,0,'rat_rel{$criterion.id_reviewsadv_review_criterion|escape:'htmlall':'UTF-8'}')"
                                                                  ...
                                                                  src="{$base_dir_ssl|escape:'htmlall':'UTF-8'}modules/reviewsadv/views/img/{$reviewsadvnoactivestar|escape:'htmlall':'UTF-8'}"
                                                                  alt=""  id="img_rat_rel{$criterion.id_reviewsadv_review_criterion|escape:'htmlall':'UTF-8'}_4" />
                                                            <img  onmouseover="_rating_efect_rev(5,0,'rat_rel{$criterion.id_reviewsadv_review_criterion|escape:'htmlall':'UTF-8'}')"
                                                                  ...
                                                                  src="{$base_dir_ssl|escape:'htmlall':'UTF-8'}modules/reviewsadv/views/img/{$reviewsadvnoactivestar|escape:'htmlall':'UTF-8'}"
                                                                  alt=""  id="img_rat_rel{$criterion.id_reviewsadv_review_criterion|escape:'htmlall':'UTF-8'}_5" />
                                                        </span>
                        {if strlen($criterion.description)>0}
                            <div class="tip-criterion-description">{$criterion.description|escape:'htmlall':'UTF-8'}</div>
                        {/if}
                    </div>
                    <input type="hidden" id="rat_rel{$criterion.id_reviewsadv_review_criterion|escape:'htmlall':'UTF-8'}"
                            name="rat_rel{$criterion.id_reviewsadv_review_criterion|escape:'htmlall':'UTF-8'}" value="{$criterion.rating|escape:'htmlall':'UTF-8'}"/>
                    {literal}
                        <script type="text/javascript">
                            $(document).ready(function(){
                                rating_review_shop('rat_rel{/literal}{$criterion.id_reviewsadv_review_criterion|escape:'htmlall':'UTF-8'}{literal}',{/literal}{$criterion.rating|escape:'htmlall':'UTF-8'}{literal});
                            });
                        </script>
                    {/literal}
                    <div class="clr"></div>
                    <div class="errorTxtAdd" id="error_rat_rel{$criterion.id_reviewsadv_review_criterion|escape:'htmlall':'UTF-8'}"></div>
         ...
         {else}
            ...
            <label for="rat_rel" class="float-left">{l s='Rating' mod='reviewsadv'}<sup class="required">*</sup></label>
            ...
            <div class="rat rating-stars-dynamic">
                                                        <span onmouseout="read_rating_review_shop('rat_rel');">
                                                            <img  onmouseover="_rating_efect_rev(1,0,'rat_rel')" onmouseout="_rating_efect_rev(1,1,'rat_rel')"
                                                                  ...
                                                                  alt=""
                                                                  id="img_rat_rel_1" />
                                                            <img  onmouseover="_rating_efect_rev(2,0,'rat_rel')" onmouseout="_rating_efect_rev(2,1,'rat_rel')" onclick = "rating_review_shop('rat_rel',2); rating_checked=true;" src="{$base_dir_ssl|escape:'htmlall':'UTF-8'}modules/reviewsadv/views/img/{$reviewsadvnoactivestar|escape:'htmlall':'UTF-8'}" alt=""  id="img_rat_rel_2" />
                                                            <img  onmouseover="_rating_efect_rev(3,0,'rat_rel')" onmouseout="_rating_efect_rev(3,1,'rat_rel')" onclick = "rating_review_shop('rat_rel',3); rating_checked=true;" src="{$base_dir_ssl|escape:'htmlall':'UTF-8'}modules/reviewsadv/views/img/{$reviewsadvnoactivestar|escape:'htmlall':'UTF-8'}" alt=""  id="img_rat_rel_3" />
                                                            <img  onmouseover="_rating_efect_rev(4,0,'rat_rel')" onmouseout="_rating_efect_rev(4,1,'rat_rel')" onclick = "rating_review_shop('rat_rel',4); rating_checked=true;" src="{$base_dir_ssl|escape:'htmlall':'UTF-8'}modules/reviewsadv/views/img/{$reviewsadvnoactivestar|escape:'htmlall':'UTF-8'}" alt=""  id="img_rat_rel_4" />
                                                            <img  onmouseover="_rating_efect_rev(5,0,'rat_rel')" onmouseout="_rating_efect_rev(5,1,'rat_rel')" onclick = "rating_review_shop('rat_rel',5); rating_checked=true;" src="{$base_dir_ssl|escape:'htmlall':'UTF-8'}modules/reviewsadv/views/img/{$reviewsadvnoactivestar|escape:'htmlall':'UTF-8'}" alt=""  id="img_rat_rel_5" />
                                                        </span>
            </div>
            <input type="hidden" id="rat_rel" name="rat_rel" value="{$reviewsadvdatareview.rating|escape:'htmlall':'UTF-8'}"/>
            {literal}
                <script type="text/javascript">
                    $(document).ready(function(){
                        rating_review_shop('rat_rel',{/literal}{$reviewsadvdatareview.rating|escape:'htmlall':'UTF-8'}{literal});
                    });
                </script>
            {/literal}
            <div class="clr"></div>
        ...
        <label for="subject-review" >{l s='Review Title' mod='reviewsadv'}<sup class="required">*</sup></label>
        <input type="text" name="subject-review" id="subject-review" value="{$reviewsadvdatareview.title_review|escape:'htmlall':'UTF-8' nofilter}"  onkeyup="check_inpSubjectReview();" onblur="check_inpSubjectReview();" />
            <div class="errorTxtAdd" id="error_subject-review"></div>
        {/if}

        {if strlen($reviewsadvdatareview.text_review)>0}
        <label for="text-review" >{l s='Review Text' mod='reviewsadv'}<sup class="required">*</sup></label>
        <textarea cols="42" rows="7" id="text-review" name="text-review" onkeyup="check_inpTextReview();" onblur="check_inpTextReview();">{$reviewsadvdatareview.text_review|escape:'htmlall':'UTF-8' nofilter}</textarea>
    ...
    <div id="footer-add-review-form-review">
        <button onclick="modify_my_review()"  value="{l s='Modify review' mod='reviewsadv'}" class="btn btn-success">{l s='Modify review' mod='reviewsadv'}</button>
    </div>
...
<script type="text/javascript">
    ...
    {/literal}{if strlen($reviewsadvdatareview.text_review)>0}{literal}
    function check_inpTextReview()
    {
        ...
        {
            field_state_change('text-review','failed', '{/literal}{$reviewsadvrcmy_msg1|escape:'htmlall':'UTF-8'}{literal}');
            return false;
        }
    ...
    {/literal}{if strlen($reviewsadvdatareview.title_review)>0}{literal}
    function check_inpSubjectReview()
    {
        ...
        {
            field_state_change('subject-review','failed', '{/literal}{$reviewsadvrcmy_msg2|escape:'htmlall':'UTF-8'}{literal}');
            return false;
        }
    ...
    {/literal}{if $reviewsadvdatareview.criterions|@count > 0}
    ...
    {foreach from=$reviewsadvdatareview.criterions item='criterion'}
        ...
        {literal}
            var rating_checked{/literal}{$criterion.id_reviewsadv_review_criterion|escape:'htmlall':'UTF-8'}{literal} = true;
    ...
    {/literal}{if $reviewsadvdatareview.rating>0}{literal}
    ...
    {foreach from=$reviewsadvdatareview.criterions item='criterion'}{literal}
    ...
    function check_inpRatingReview{/literal}{$criterion.id_reviewsadv_review_criterion|escape:'htmlall':'UTF-8'}{literal}()
    {
        ...
        if(!rating_checked{/literal}{$criterion.id_reviewsadv_review_criterion|escape:'htmlall':'UTF-8'}{literal}){
            field_state_change('rat_rel{/literal}{$criterion.id_reviewsadv_review_criterion|escape:'htmlall':'UTF-8'}{literal}','failed', '{/literal}{$reviewsadvrcmy_msg3|escape:'htmlall':'UTF-8'} {$criterion.name|escape:'htmlall':'UTF-8'}{literal}');
            return false;
        }
    ...
    {
        if(!rating_checked){
            field_state_change('rat_rel','failed', '{/literal}{$reviewsadvrcmy_msg4|escape:'htmlall':'UTF-8'}{literal}');
            return false;
        }
        ...
        {/literal}{/if}{literal}
            ...
            $.post(baseDir+'modules/reviewsadv/reviews.php',
                    ...
                    text_review: $('#text-review').val(),
                        ...
                        {foreach from=$reviewsadvdatareview.criterions item='criterion'}{literal}
                        rating{/literal}{$criterion.id_reviewsadv_review_criterion|escape:'htmlall':'UTF-8'}{literal}:$('#rat_rel{/literal}{$criterion.id_reviewsadv_review_criterion|escape:'htmlall':'UTF-8'}{literal}').val(),
                        {/literal}{/foreach}{literal}
                    ...
                    function (data) {
                        ...
                        if (data.status == 'success') {
                            ...
                            var html = '<img alt="{/literal}{$reviewsadvrcmy_msg5|escape:'htmlall':'UTF-8'}{literal}"'+
                                        'title="{/literal}{$reviewsadvrcmy_msg5|escape:'htmlall':'UTF-8'}{literal}"'+
