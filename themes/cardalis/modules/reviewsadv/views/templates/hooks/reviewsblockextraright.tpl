...
{if $reviewsadvrvis_on == 1}
        ...
        {if $reviewsadvratings_on == 1 || $reviewsadvtitle_on == 1 || $reviewsadvtext_on == 1}
            ...
            {if $reviewsadvhooktodisplay == "extra_right"}

                <div class="clear-reviewsadv"></div>

                <div class="{if $reviewsadvis16 == 1}gsniprev-block-16{else}gsniprev-block{/if}">
                    <b class="title-rating-block">
                        <img alt="Total étoiles" src="{$base_dir_ssl|escape:'htmlall':'UTF-8'}modules/reviewsadv/views/img/{$reviewsadvactivestar|escape:'htmlall':'UTF-8'}" />&nbsp;{l s='Total Rating' mod='reviewsadv'}</b><span class="ratings-block-punct">:</span>
                    <br/><br/>
