...
{if $reviewsadvrvis_on == 1}
    ...
    {if $reviewsadvratings_on == 1 || $reviewsadvtitle_on == 1 || $reviewsadvtext_on == 1}
        ...
        {if $reviewsadvis_blocklr == 1 && ($reviewsadvis_home_bottom == 1 || $reviewsadvis_cat_bottom == 1 || $reviewsadvis_man_bottom == 1 || $reviewsadvis_prod_bottom == 1 || $reviewsadvis_oth_bottom == 1)}
        ...
        {if $reviewsadvis16 == 1}
            ...
            {if $reviewsadvis17 == 1}
                <div class="col-xs-12 col-sm-3 wrapper links" style="width:{$reviewsadvblocklr_w|escape:'htmlall':'UTF-8'}%">
            {else}
                <section class="footer-block col-xs-12 col-sm-3" style="width:{$reviewsadvblocklr_w|escape:'htmlall':'UTF-8'}%">
            {/if}
        {else}
                <div class="clear-reviewsadv"></div>
                <div id="reviewsadv_block_footer" class="block-last-reviewsadvs footer-block blockmanufacturer" style="width:{$reviewsadvblocklr_w|escape:'htmlall':'UTF-8'}%">
        {/if}




                <h4 {if $reviewsadvis17 == 1}class="h3 hidden-sm-down"{/if}>
                ...
                <div data-toggle="collapse" data-target="#last_reviews_block_footer" class="title clearfix hidden-md-up">
                    <span class="h3">{l s='Last Product Reviews' mod='reviewsadv'}</span>
                ...
                <div class="block_content block-items-data toggle-footer {if $reviewsadvis17 == 1}collapse{/if}" {if $reviewsadvis17 == 1}id="last_reviews_block_footer"{/if}>
                        ...
                        {foreach from=$reviewsadvreviews_block item=review name=myLoop}
                            ...
                            <div class="items-last-reviewsadvs ">
                                ...
                                {if $review.product_img}
                                    <div class="img-block-reviewsadv col-xs-2-custom">
                                ...
                                {/if}
                                <div class="body-block-reviewsadv col-xs-10-custom {if !$review.product_img}body-block-reviewsadv-100{/if}">
...
{if $reviewsadvradv_footer == 1}
    ...
    {else}
        <div class="clear"></div>
        <div id="reviewsadv_block_footer_users" class="block footer-block {if $reviewsadvis16 == 1}blockmanufacturer16-footer{else}blockmanufacturer{/if}"
        >
    {/if}
		...
		<div class="block_content block-items-data toggle-footer {if $reviewsadvis17 == 1}collapse{/if}" {if $reviewsadvis17 == 1}id="all_users_block_footer"{/if}>
