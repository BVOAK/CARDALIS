...
{if $reviewsadvrvis_on == 1}
    ...
    {if $reviewsadvratings_on == 1 || $reviewsadvtitle_on == 1 || $reviewsadvtext_on == 1}
        ...
        {if $reviewsadvis_blocklr == 1 && ($reviewsadvis_home_leftcol == 1 || $reviewsadvis_cat_leftcol == 1 || $reviewsadvis_man_leftcol == 1 || $reviewsadvis_prod_leftcol == 1 || $reviewsadvis_oth_leftcol == 1)}





            <div id="reviewsadv_block_left" class="block blockmanufacturer {if $reviewsadvis17 == 1}block-categories{else}block-last-reviewsadvs{/if}" {if isset($reviewsadvallinfoh_w)}style="width:{$reviewsadvallinfoh_w|escape:'htmlall':'UTF-8'}%"{/if}>
...
{if $reviewsadvradv_left == 1}

    <div id="reviewsadv_block_left_users"  class="block {if $reviewsadvis16 == 1}blockmanufacturer16{else}blockmanufacturer{/if} {if $reviewsadvis17 == 1}block-categories{/if}" >
