...
{if $reviewsadvhooktodisplay == "extra_left"}

<div class="clear-reviewsadv"></div>

<div class="{if $reviewsadvis16 == 1}gsniprev-block-16{else}gsniprev-block{/if}">
<b class="title-rating-block">
    <img src="{$base_dir_ssl|escape:'htmlall':'UTF-8'}modules/reviewsadv/views/img/{$reviewsadvactivestar|escape:'htmlall':'UTF-8'}" class="title-rating-one-star" alt="{l s='Total Rating' mod='reviewsadv'}" />&nbsp;{l s='Total Rating' mod='reviewsadv'}</b><span class="ratings-block-punct">:</span>
<br/><br/>
