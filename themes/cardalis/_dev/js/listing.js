...
$(document).ready(() => {
  ...
  $('body').on('click', '.js-search-link', function (event) {
    ...
    $(document).scrollTo('#headerCategory',500);
  });
...
$(document).ready( function() {
    ...
    var $nbProduct = $(".product-miniature").length;
    console.log($nbProduct);
    if ($nbProduct % 4 == 1) {
        $(".emptyProduct").removeClass("hide");
    } else {
        $(".emptyProduct").addClass("hide");
    }

    //$(window).resize(updateSize);
    $("#childCat .contentHover").each(function(){
