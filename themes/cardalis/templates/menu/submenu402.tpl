        ...
        <div class="block wrapper justify-content-center">
            <div class="colMenu">
                <div class="d-flex">
                    ...
                    <div class="blockBanner">
                        <a href="{$link->getCategoryLink(404)|escape:'html':'UTF-8'}"
                            style="background-image: url('{$urls.img_url}encart-cartes-eco-137.png')"
                            class="width1 bannerImg">
                    ...
                    <div class="blockBanner">
                        <a href="{$link->getCategoryLink(406)|escape:'html':'UTF-8'}"
                            style="background-image: url('{$urls.img_url}encart-porte-badge-eco-171.png')"
                            class="width1 bannerImg">
                            <span class="titleCat">Porte-badges écologiques</span>
                        </a>
                    </div>
                    <div class="blockBanner">
                        <a href="{$link->getCategoryLink(407)|escape:'html':'UTF-8'}?q=Type-Écologique+🌱"
                            style="background-image: url('{$urls.img_url}encart-boite-recyclage-407.png')"
                            class="width1 bannerImg">
                    ...
                    <div class="blockBanner">
                        <a href="{$link->getCMSLink(243)|escape:'html':'UTF-8'}"
                            style="background-image: url('{$urls.img_url}encart-engagement-rse.jpg')"
                            class="width1 bannerImg">
