...
<input id="inputTypeBracelet" type="hidden" value="Satiné" />

<section id="sectionHead">
    <div class="row wrapper">
        <div class="col-lg-7 blockText">
            <h1 class="titleCat">
                <span>TOURS DE COU</span> {$block39901->meta_title nofilter}
            </h1>
            <div class="description">
                {$block39901->content nofilter}
            </div>
        </div>
        <div class="img col-lg-5 text-center">
            <img class="img-fluid" src="{$urls.img_url}lanyards-imprimes-satines-header.jpg"
                alt="Tours de cou imprimés {$block39901->meta_title nofilter}" />
        </div>
    </div>
</section>
...
<div class="row wrapper catContent" id="blockSummary">
    <div class="col-lg-8 position-relative p-md-2 p-0">
        <section id="sectionType">
            <h2 class="titleSec">
                {$block39902->meta_title nofilter}
            </h2>
            <div class="description">
                {$block39902->content nofilter}
            </div>
        </section>
    </div>
...
<section id="sectionStep" class="padSection50 u-bor-top">
    <div class="row wrapper flex-column align-items-center">
        <h2 class="titleSec w-100 text-center">
            {$blockBICom02->meta_title nofilter}
        </h2>
        <div id="blockStepList">
