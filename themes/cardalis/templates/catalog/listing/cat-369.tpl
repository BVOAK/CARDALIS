...
{* <section id="sectionHead">
    <div class="row wrapper">
        <div class="col-lg-7 blockText">
            <h1 class="titleCat">
                {$block36901->meta_title nofilter}
            </h1>
            <div class="description">
                {$block36901->content nofilter}
            </div>
        </div>
        <div class="img col-lg-5 text-center">
            <img class="img-fluid" src="{$urls.img_url}bracelets-imprimes-header.jpg"
                alt="{$block36901->meta_title nofilter}" />
        </div>
    </div>
</section>
...
<section id="sectionListCatsChild" class="padSection50 bgBlueLight">
    <div class="row wrapper">
        <h2 class="titleSec cWhite m-auto pb-4 text-center">
            {$block36902->meta_title nofilter}
        </h2>
    </div>
    <div class="blockItemList p-3">
        {$block36902->content nofilter}
    </div>
</section>
...
<section id="sectionStep" class="padSection50 u-bor-top bgGrey">
    <div class="row wrapper flex-column align-items-center">
        <h2 class="titleSec text-center">
            {$block36903->meta_title nofilter}
        </h2>

        <div id="blockStepList" class="d-flex">
            {$block36903->content nofilter}
        </div>
    </div>
    <div class="row wrapper flex-column align-items-center">
        <a href="#sectionDemande" class="btn btn-primary btn-outline mt-3">{l s="Demandez votre devis ici" d='Shop.Theme.Catalog'}</a>
