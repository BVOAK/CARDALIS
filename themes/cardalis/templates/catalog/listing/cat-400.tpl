...
<input id="inputTypeBracelet" type="hidden" value="Tramés" />

<section id="sectionHead">
    <div class="row wrapper">
        <div class="col-lg-7 blockText">
            <h1 class="titleCat">
                <span>TOURS DE COU</span> {$block40001->meta_title nofilter}
            </h1>
            <div class="description">
                {$block40001->content nofilter}
            </div>
        </div>
        <div class="img col-lg-5 text-center">
            <img class="img-fluid" src="{$urls.img_url}lanyards-imprimes-trames-header.jpg"
                alt="Tours de cou imprimés {$block40001->meta_title nofilter}" />
        </div>
    </div>
</section>
...
<div class="row wrapper catContent" id="blockSummary">
    <div class="col-lg-8 position-relative p-md-2 p-0">
        <section id="sectionType">
            <h2 class="titleSec">
                {$block40002->meta_title nofilter}
            </h2>
            <div class="description">
                {$block40002->content nofilter}
            </div>
        </section>
    </div>
