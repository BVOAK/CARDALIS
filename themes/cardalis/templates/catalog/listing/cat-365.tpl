...
<div class="catContent">
    ...
    <section id="sectionSolutionsEtiquettes" class="padSection50 u-bor-top">
        <div class="row">
            <div class="wrapper">
    ...
    <section id="sectionEtiquettesDifference" class="padSection50">
        <div class="row wrapper ">
            <div class="col-lg-9 row align-items-center m-auto">
                <div class="col-lg-6">
    ...
    <section id="sectionReviewsEtiquettes" class="sectionReviews padSection50 u-bor-bot">
        <div class="row wrapper">
            <h2 class="titleSec m-auto">
    ...
    <section id="sectionFormEtiquettes" class="padSection50">
        <div class="row wrapper">
            <div class="blockImg col-lg-7">
                <img class="img-fluid" src="{$urls.img_url}etiquettes-demande-form.jpg"
                    alt="{$block36202->meta_title nofilter}" />
            </div>
            <div class="blockForm col-lg-5 p-4">
                <p class="titleSec mb-4">Demandez vos échantillons d’étiquettes avec leurs supports</p>
