...
<div id="js-product-list-top" class="row products-selection">
    ...
    <div class="col-md-6">
        ...
        {if !empty($listing.rendered_facets)}
            <button type="button" id="search_filter_toggler" class="btn btn-primary hidden-md-up"
                data-target="#offcanvas_search_filter" data-toggle="modal">
                <i class="fa fa-sliders" aria-hidden="true"></i>{l s='Filter' d='Shop.Theme.Actions'}
            </button>
        {/if}
    </div>
</div>