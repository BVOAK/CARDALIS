...
{block name='page_title'}
  <div class="headerTitle">
    <h1 class="h1 mainTitle">{l s='Order details' d='Shop.Theme.Customeraccount'}</h1>
  </div>
{/block}
      ...
      <div class="box">
          <div class="row">
            <div class="col-md-{if $order.details.reorder_url}9{else}12{/if}">
              <strong>
                {l
                  s='Order Reference %id% - placed on %date%'
                  d='Shop.Theme.Customeraccount'
                  sprintf=['%id%' => $order.details.id, '%date%' => $order.details.order_date]
                }
              </strong>
            </div>
