...
{block name='page_title'}
  <div class="headerTitle">
    <h1 class="h1 mainTitle">{l s='Credit slips' d='Shop.Theme.Customeraccount'}</h1>
  </div>
{/block}
    ...
    <table class="table table-striped table-bordered hidden-sm-down">
      ...
      <tbody>
        {foreach from=$credit_slips item=slip}
          <tr>
            <td><a href="{$slip.order_url_details}" data-link-action="view-order-details">{$slip.id_order}</a></td>
        ...
        <div class="credit-slip">
          <ul>
            <li>
              ...
              <a href="{$slip.order_url_details}" data-link-action="view-order-details">{$slip.id_order}</a>
            </li>
            <li>
