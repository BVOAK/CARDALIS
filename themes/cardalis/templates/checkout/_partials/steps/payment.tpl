        ...
        <div>
          <div id="{$option.id}-container" class="payment-option clearfix">
            ...
            <label for="{$option.id}">
              ...
              {if $option.logo}
                <img src="{$option.logo}" alt="Logo option de paiement">
              {/if}
            </label>
  ...
  <div id="payment-confirmation">
    <div class="ps-shown-by-js">
      <button type="submit" {if !$selected_payment_option} disabled {/if} class="btn btn-primary center-block">
        {l s='Je valide ma commande' d='Shop.Theme.Checkout'}
      </button>
      {if $show_final_summary}
    ...
    <div class="ps-hidden-by-js">
      {if $selected_payment_option and $all_conditions_approved}
        <label for="pay-with-{$selected_payment_option}">{l s='Je confirme et je paie' d='Shop.Theme.Checkout'}</label>
      {/if}
    </div>
  </div>
