...
{block name='step_content'}
                  ...
                  <div class="delivery-option">
                    <div class="blockRadio">
                      <span class="custom-radio">
                        <input type="radio" class="delivery_option_radio" name="delivery_option[{$id_address}]" id="delivery_option_{$carrier.id}" value="{$carrier_id}"{if $delivery_option == $carrier_id} checked{/if}>
                        <span></span>
                      </span>
                    </div>
  ...
  <div id="extra_carrier"></div>
          ...
          <div class="order-options">
              <div id="delivery">
                  <p class="title">{l s='Commentaires sur la commande' d='Shop.Theme.Checkout'}</p>
                  <label for="delivery_message">{l s='Si vous désirez ajouter un commentaire à propos de votre commande, laissez un message dans le champs ci-dessous.' d='Shop.Theme.Checkout'}</label>
